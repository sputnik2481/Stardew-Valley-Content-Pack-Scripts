...
# This is the list of inputs explained:
...
animation: if there exists an animation it takes in an array of ordered pair where (line of dialog, animation) (coming eventually)
